...
function generateAhkScript(data: any): string {
  ...
  const fillTransactionRow = (transactionData: any, rowNumber: number) => {
    ...
    ahkLines.push('')
    ahkLines.push('; Enter 2x untuk navigasi ke field Amount (cepat)')
    ahkLines.push('Send, {Enter}')
    ahkLines.push('Sleep, 200')
    ahkLines.push('Send, {Enter}')
    ahkLines.push('Sleep, 200')
    ...
    ahkLines.push('Sleep, 100')
    ahkLines.push('')
    ahkLines.push('; Enter 1x untuk navigasi ke field Exchange Rate (cepat)')
    ahkLines.push('Send, {Enter}')
    ahkLines.push('Sleep, 200')
    ahkLines.push('')
    ...
    ahkLines.push('Sleep, 100')
    ahkLines.push('')
    ahkLines.push('; Enter untuk konfirmasi baris transaksi')
    ahkLines.push('Send, {Enter}')
    ahkLines.push('Sleep, 300')
    ahkLines.push('')
  }
  ...
  if (transactions.length > 0) {
    ...
    ahkLines.push('Sleep, 100')
    ahkLines.push('')
    ahkLines.push('; Enter 2x untuk navigasi ke field Code Currency (tanpa delay)')
    ahkLines.push('Send, {Enter}')
    ahkLines.push('Sleep, 200')
    ahkLines.push('Send, {Enter}')
    ahkLines.push('Sleep, 200')
    ...
    transactions.forEach((transaction, index) => {
      ...
      if (index < transactions.length - 1) {
        ...
        if (nextTransactionNumber > 8) {
          ...
          ahkLines.push('; Enter 2x untuk navigasi ke baris transaksi berikutnya (cepat)')
          ahkLines.push('Send, {Enter}')
          ahkLines.push('Sleep, 200')
          ahkLines.push('Send, {Enter}')
          ahkLines.push('Sleep, 200')
    ...
    ahkLines.push('Sleep, 300')
    ahkLines.push('')
    ahkLines.push('; Enter 1x untuk mengakhiri input transaksi')
    ahkLines.push('Send, {Enter}')
    ahkLines.push('Sleep, 300')
  } else {
  ...
  ahkLines.push('; Enter 1x untuk mengakhiri semua input (berlaku untuk BNB dan BNS)')
  ahkLines.push('Send, {Enter}')
  ahkLines.push('Sleep, 300')
  ahkLines.push('')
  ahkLines.push('Sleep 500')
  ahkLines.push('MsgBox, 64, Success, Script Completed - Semua data berhasil diinput!')
