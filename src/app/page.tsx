...
async function generateAndDownloadAHK(data: any, valasTransactions: any[] = []) {
  try {
    ...
    const res = await fetch('/api/generate-ahk', {
      ...
      body: JSON.stringify({
        ...
        transactionType: data.transactionType || data.jenisTransaksi || 'BNB',
...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await generateAndDownloadAHK(formData, activeValasTransactions);
